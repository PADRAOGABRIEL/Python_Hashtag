...
faturamento_Pepsi = qtde_vendasPepsi * preco_Pepsi
print(faturamento_Pepsi)

print("2. Qual foi o faturamento de Coca da Loja?")

faturamento_Coca = qtde_vendasCoca * preco_Coca
print(faturamento_Coca)

print("3. Qual foi o Lucro da loja?")

faturamento_total = faturamento_Coca + faturamento_Pepsi
lucro_loja = faturamento_total - custo_loja
print(lucro_loja)

print("4. Qual foi a Margem da Loja? (Lembre-se, margem = Lucro / Faturamento). Não precisa formatar em percentual")
...
bebida = input("Passe o código da bebida com LETRAS MAIÚSCULAS: ")
