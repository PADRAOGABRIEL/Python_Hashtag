...
"""cpf_user = input('Digite seu cpf (Digite apenas numeros): ')

if len(cpf_user) == 11 and cpf_user.isnumeric():
    print('cpf cadastrado com sucesso: ' + str(cpf_user))
else:
...
cpf_user = cpf_user.strip()

cpf_user = cpf_user.replace('.','')
...
if nome and email:
    ...
    print('nome ou email nao preenchidos')